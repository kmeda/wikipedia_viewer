    ...
    $.ajax({
        ...
        success: function (x) {
            ...
            for (var i = 0; i < x.query.search.length; i++){
              var contentHTML = '<a href=https://en.wikipedia.org/wiki/'+encodeURIComponent(x.query.search[i].title)+' target="_blank"><div class="articles-00 articles"><p class="title">'+x.query.search[i].title +'</p><p class="summary">'+x.query.search[i].snippet +'</p></div>'
